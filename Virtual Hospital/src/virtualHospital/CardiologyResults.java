 ...
 * @author sshth
 */
public class CardiologyResults extends javax.swing.JFrame {
public String[] HeartListDiseases;
int index;public String[][]Dataa;

    /**
     * Creates new form EyeResults
     */
    public CardiologyResults() {
        initComponents();
    }

   public CardiologyResults(int n, String[] HeartDiseases,String[][]id) {
       index=n;
       Dataa=id;
       HeartListDiseases=HeartDiseases;
       initComponents();
   }
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
       String text2="<html>You can also come back to us for any problem<br>but we will suggest you to visit our verified Pyhsician.<br><br><br>DR. MOHAMMAD AKRAM<br>Kulsum International Hospital<br>Phone Number +923155862296</html>";
        traetmentLabel1.setText(text2);
        FileReader fr = null;
        int n=0;
        DiseaseLabel.setText(HeartListDiseases[index]);
    try {
        
        File file = new File("./src/VirtualHospital/Files/Brain.txt");
    ...
    try {
        ...
        pw.println(Dataa[0][0]+","+HeartListDiseases[index]);
