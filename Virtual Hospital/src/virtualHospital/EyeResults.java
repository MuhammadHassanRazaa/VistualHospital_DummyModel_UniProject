 ...
 * @author sshth
 */
public class EyeResults extends javax.swing.JFrame {
...
public String Dataa[][]=null;
   ...
   public EyeResults(int n, String[] EyeDiseases,String[][]id) {
       index=n;
    ...
    try {
        ...
        Logger.getLogger(EyeResults.class.getName()).log(Level.SEVERE, null, ex);
    } 
