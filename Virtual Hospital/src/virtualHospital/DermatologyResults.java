 ...
 * @author sshth
 */
public class DermatologyResults extends javax.swing.JFrame {
public String[] DermatologyDiseases;
int index;public String Dataa[][]=null;

    /**
     * Creates new form EyeResults
     */
    public DermatologyResults() {
        initComponents();
    }

   public DermatologyResults(int n, String[] EyeDiseases,String[][]Data) {
       index=n;
       DermatologyDiseases=EyeDiseases;
       Dataa=Data;
       initComponents();
   }
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
       String text2="<html>You can also come back to us for any problem<br>but we will suggest you to visit our verified Pyhsician.<br><br><br>DR. ISHRAT ALI<br>Chaudhry Rehmat Ali Memorial Trust Hospital<br>Phone Number +92425151345</html>";
        ...
        FileReader fr = null;
        int n=0;
        DiseaseLabel.setText(DermatologyDiseases[index]);
    try {
        
        File file = new File("./src/VirtualHospital/Files/Dermatology.txt");
    ...
    try {
        ...
        pw.println(Dataa[0][0]+","+DermatologyDiseases[index]);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DermatologyResults.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DermatologyResults().setVisible(true);
            }
        });
    }
