 ...
 * @author sshth
 */
public class DigestionResults extends javax.swing.JFrame {
public String[] DIgestionListDiseas;
int index;String[][]Dataa=null;

    /**
     * Creates new form EyeResults
     */
    public DigestionResults() {
        initComponents();
    }

   public DigestionResults(int n, String[] DIgestiveDiseases,String data[][]) {
       index=n;
       Dataa=data;
       DIgestionListDiseas=DIgestiveDiseases;
       initComponents();
   }
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
       String text2="<html>You can also come back to us for any problem<br>but we will suggest you to visit our verified Pyhsician.<br><br><br>DR. ISHRAT ALI<br>Chaudhry Rehmat Ali Memorial Trust Hospital<br>Phone Number +92425151345</html>";
        ...
        FileReader fr = null;
        int n=0;
        DiseaseLabel.setText(DIgestionListDiseas[index]);
    try {
        
        File file = new File("./src/VirtualHospital/Files/Digestive.txt");
        ...
        Logger.getLogger(DigestionResults.class.getName()).log(Level.SEVERE, null, ex);
    } 
    ...
    try {
        ...
        pw.println(Dataa[0][0]+","+DIgestionListDiseas[index]);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DigestionResults.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DigestionResults().setVisible(true);
            }
        });
    }
