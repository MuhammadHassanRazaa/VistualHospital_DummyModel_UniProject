 ...
 * @author sshth
 */
public class BrainResults extends javax.swing.JFrame {
public String[] EYeListDisease;public String Dataa[][]=null;
int index;
   ...
   public BrainResults(int n, String[] EyeDiseases,String[][]Data) {
       index=n;
       Dataa=Data;
    ...
    try {
        ...
        Logger.getLogger(BrainResults.class.getName()).log(Level.SEVERE, null, ex);
    } 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BrainResults.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BrainResults().setVisible(true);
            }
        });
    }
