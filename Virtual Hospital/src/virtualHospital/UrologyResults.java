 ...
 * @author sshth
 */
public class UrologyResults extends javax.swing.JFrame {
public String[] UrologyDiseases;public String[][]Dataa=null;
int index;

    /**
     * Creates new form EyeResults
     */
    public UrologyResults() {
        initComponents();
    }

   public UrologyResults(int n, String[] EyeDiseases,String[][]id) {
       index=n;
       Dataa=id;
       UrologyDiseases=EyeDiseases;
       initComponents();
   }
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
       String text2="<html>You can also come back to us for any problem<br>but we will suggest you to visit our verified Pyhsician.<br><br><br>DR. ISHRAT ALI<br>Chaudhry Rehmat Ali Memorial Trust Hospital<br>Phone Number +92425151345</html>";
        ...
        FileReader fr = null;
        int n=0;
        DiseaseLabel.setText(UrologyDiseases[index]);
    try {
        
        File file = new File("./src/VirtualHospital/Files/Urology.txt");
        ...
        Logger.getLogger(UrologyResults.class.getName()).log(Level.SEVERE, null, ex);
    } 
    ...
    try {
        ...
        pw.println(Dataa[0][0]+","+UrologyDiseases[index]);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UrologyResults.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UrologyResults().setVisible(true);
            }
        });
    }
